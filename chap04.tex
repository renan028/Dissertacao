...
\section{Testes da implementação da camada Executivo e
Planejador}\label{avaexecutivo}
...
\textbf{Suporte a paralelismo} e \textbf{Suporte a modularidade}. Além disso,
...
\textbf{Suporte a modularidade} e \textbf{Tempo de desenvolvimento}, utilizando
...
\textbf{Suporte a paralelismo}
\textbf{\textit{Hardware targetability}}
\textbf{\textit{Niche targetability}}
\textbf{Suporte a modularidade}
\textbf{Robustez}
\textbf{Tempo de desenvolvimento}
\textbf{Flexibilidade em tempo de execução}
\textbf{Desempenho em executar tarefas}
...
A DORIS é um robô móvel com aplicação de inspeção em um ambiente dinâmico.
...
que armazena as imformações do ambiente (mapas e obstáculos) de maneira
...
e não possui o modelo do mundo \cite{tribelhorn2007evaluating} (figura~\ref{roomba}).
...
arquitetura híbrida e implementar em um robô. O objetivo do robô era reconhecer
...
deliberativa: Planejador e Cartógrafo, o terceiro é um subsistema de sensores,
quarto é subsistema de gerenciador de comportamentos (gerenciador esquema motor)
e o último subsistema de controle homeostático.
...
O controle homeostático, quinto subsistema, assume um papel intermediário entre os sistemas deliberativo e reativo. Sua função é modificar a relação entre
...
resposta a necessidades internas. A figura~\ref{aura} mostra os cinco subsistemas da arquitetura AuRA. A tabela~\ref{auratable} resume a arquitetura.
...
Em 1996, Healey \cite{healey1996autonomous}, California, aplica técnicas de
controle híbrido em seu trabalho de desenvolvimento do AUV Phoenix.  Healey
propõe uma arquitetura de software híbrida com três níveis organizacionais e

...
\textbf{Definição 2:} Uma \textbf{arquitetura robótica} é uma arquitetura que
...
tempo de execução} e \textbf{Desempenho em executar tarefas} (detalhes em
...
ser realizadas na nuvem, como planejamento de segurar objetos (\textit{grasp

...
aplicabilidade do robô, entende-se que:
 ...
 \emph{Definição:} Uma \emph{arquitetura robótica} descreve
...
\emph{Definição:} o controle de missão de robôs é o componente da arquitetura
...
robô. Como faz parte da arquitetura, as seções que seguem buscam, em cada
arquitetura, destacar de forma exemplificada alguns controles de missão.
...
\subsection{Robot Operating System - ROS}\label{ros}

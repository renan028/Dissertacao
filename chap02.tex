...
\begin{figure}[h!]
\centering
\includegraphics[width=1\columnwidth]{figs/georgerobot.jpg}
\caption{Robô George.}
\label{george}
\end{figure}
...
Architecture (AuRA) e AUV Phoenix.
...
resposta a necessidades internas. A FIGURA mostra os cinco subsistemas da
arquitetura AuRA.

\subsubsection{AUV Phoenix}

...
(gerenciamento de recursos). A camada Executivo é o foco da implementação do
autor desta dissertação e, junto com a camada Planejador, permite a autonomia do
robô.

A camda Executivo elaborada para a DORIS usará técnicas da arquitetura de
subsunção simplificada, onde o módulo básico de comportamento será a máquina de
estado aumentada (\emph{AFSM}) da figura~\ref{afsm} sem \textit{Reset}.
...
TDL e SMACH suportam terminação de tarefas baseado na ocorrência de eventos

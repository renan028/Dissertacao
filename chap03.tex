...
\begin{itemize}
  ...
  todos as missões e processos reativos. O processo envia mensagem 'Abort' aos
  tópicos de todas as missões: \textit{'DORIS/MCS/INSPECTION'},
  \textit{'DORIS/MCS/PATROL'},
  \textit{'DORIS/MCS/RECORD\_TYPE'},\textit{'DORIS/MCS/GOTO'}; e a alguns
  ...
  o robô suspende as missões. O processo envia mensagem 'Abort' aos
  tópicos de todas as missões: \textit{'DORIS/MCS/INSPECTION'},
  \textit{'DORIS/MCS/PATROL'},
  \textit{'DORIS/MCS/RECORD\_TYPE'},\textit{'DORIS/MCS/GOTO'}.
\end{itemize}
...
\begin{itemize}
  ...
  obstáculo \cite{christensen2011cost}. Este processo aborta a tarefa
  \textbf{MOTION\_POSITION\_CONTROL}, pertencente à missão \textbf{GOTO},
  enviando mensagem ROS 'Abort' ao tópico
  \textit{'DORIS/MCS/MOTION\_POSITION\_CONTROL'}.
\end{itemize}

...
Desenvolvimento da Petrobras (CENPES) e sua extensão é cerca de 140 m. As
figuras~\ref{doris} e \ref{cenpes} ilustram o robô, o trilho e o ambiente em que
trabalha.

\begin{figure}[!ht]
\centering
\includegraphics[width=.8\columnwidth]{figs/DORIS/2_1.png}
\caption{A DORIS e o trilho.}
\label{doris}
\end{figure}
...
Na seção~\ref{doris}, foi apresentada a DORIS e suas funcionalidades. Como
...
DORIS, ainda é necessário desenvolver a implementação de cada camada, isto
é, como e qual executará as funções descritas por Murphy: sequenciador,
gerenciador de recurso, cartógrafo, controle de missão, e monitor de
...
apresenta suas peculiaridades, as camadas da DORIS são detalhadas
adiante.

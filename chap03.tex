...
faz necessário, mas a construção de modelos distintos para cada funcionalidade
...
emergenciais. As exigências de um controle de missão para inspeção flexível,
modelos de mundo atualizados e a robustez no controle do robô demandam uma
arquitetura híbrida.

...
destacando suas responsabilidades e suas interligação com outras camadas e
internamente.
...
sequência, aborta processos dependentes, por exemplo, os \textit{processos reativos específicos} de uma
determinada missão. 
...
quando uma mensagem ROS ``Abort" é enviado ao tópico \textit{DORIS/MCS/Goto} e,
na sequência, aborta seu \textit{processo reativo específico}
\textbf{OBSTACLE\_DETECTION}, enviando mensagem ROS ``Abort'' ao tópico
\textit{DORIS/MCS/ObstacleDetection} (figura~\ref{supression}).

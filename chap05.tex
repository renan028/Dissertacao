...
contextualização e escalabilidade, são contornadas a partir de uma
...
componentes com os elementos de hardware do robô. Drivers de sensores,
atuadores e algoritmos são testados, e o robô pode ser teleoperado com joystick ou por
...
Dessa forma, a dissertação é um estudo no tema de arquiteturas
...
da camada Funcional e deve ser implementada simultaneamente. O agendador não é
